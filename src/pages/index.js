    ...
    <Layout>
      ...
      <div className="home-page-wrapper" >
        <div className="home-page-heading">
          <StaticImage src="../images/logo-transparent.png" alt="Flex Moving Logo" width={200} style={{ marginLeft: '20px' }} />
      ...
      <Box className="appointment-wrapper">
        <div className="appointment-image">
          <img src={appointment} alt="Moving company NYC" />
        </div>
        <div className="estimate-container">
          <div>
            <h3>Looking for onsite estimate?</h3>
            <h3 style={{ color: 'red' }}>FREE!</h3>
            <Typography>Flex Moving offering to our customers free onsite estimate... Call us and our agent will be in your home and make moving day easier.</Typography>
            <Button
              style={{ backgroundColor: '#055793', color: '#fff', marginTop: '20px' }}
              variant="contained"
